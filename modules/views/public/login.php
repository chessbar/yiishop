        ...
        <div class="row-fluid login-wrapper">
            ...
            <div class="span4 box">
                    <div class="content-wrap">
                        <h6>登录</h6>
                        <?php echo $form->field($model,'user')->textInput(["class"=>"span12","placeholder"=>"管理员账号"]);?>
                        <?php echo $form->field($model,'pwd')->passwordInput(["class"=>"span12","placeholder"=>"管理员密码"]);?>
                        <?php echo $form->field($model,'rememberMe')->checkbox(["id"=>"remember-me","template"=>'<div class="remember">{input}<label for="remember-me">7天免登录</label></div>']);?>
